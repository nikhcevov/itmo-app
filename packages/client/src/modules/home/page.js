      ...
      <div className={classes.content}>
        <Container maxWidth='lg' className={classes.container}>
          ...
          <Typography variant='body1' className={classes.text} gutterBottom>
            Приложение-агрегатор ITMO-APP разработано для облегчения
